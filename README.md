# ej2-azure-aspmvc-file-provider
...
To run this application, clone the [`ej2-azure-aspmvc-file-provider`](https://github.com/ej2-azure-aspmvc-file-provider) repository and then navigate to its appropriate path where it has been located in your system.

To do so, open the command prompt and run the below commands one after the other.

```

git clone https://github.com/ej2-azure-aspmvc-file-provider  ej2-azure-aspmvc-file-provider

cd ej2-azure-aspmvc-file-provider
